...
function Home() {
  return (
    <div className="flex flex-col justify-center pb-[8rem]  bg-black items-center md:flex-row mb-[5rem] md:mb-[10rem] h-screen px-4 md:px-8">
    {/* Greeting and all */}
    <div className="w-full  md:w-[60%] flex  md:pt-[6rem] mb-[3rem] md:mb-0 flex-col items-center md:items-start justify-center gap-8">
